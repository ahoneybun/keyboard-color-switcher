...
class MainWindow(Gtk.Window):
    ...
    if self.is_multi_color:
        self.page1.add(Gtk.ColorButton(self.left_button, self.left_label = self._create_control_button("Left"))
        self.page1.add(Gtk.ColorButton(self.right_button, self.right_label = self._create_control_button("Right"))
